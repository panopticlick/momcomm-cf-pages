...
export const TaskStatusSummary: React.FC = () => {
  ...
  useEffect(() => {
    fetchStats()
    // Optional: could set up polling here if needed
  }, [])
  ...
  if (error) return null // Hide on error to not clutter the UI
        ...
        return (
          <div
            ...
            style={{
              padding: '12px 16px',
              background: 'var(--theme-elevation-50)',
              // Using theme bg instead of colored bg to match Payload UI better,
              // but adding colored border/text accent
              borderRadius: '6px',
              border: `1px solid ${style.border}`, // var(--theme-elevation-100)
              display: 'flex',
              flexDirection: 'column',
              minWidth: '100px',
              position: 'relative',
          ...
          >
            ...
            <span
              style={{
                ...
                textTransform: 'uppercase',
                letterSpacing: '0.5px',
                color: 'var(--theme-elevation-400)', // style.text?
                marginBottom: '4px',
                paddingLeft: '8px',
              }}
            >
